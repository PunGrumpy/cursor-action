...
Check the job summary. A cancelled or timed-out run exits with code `1` and marks the step as failed. You can increase `timeout` if the agent needs more time to complete.
